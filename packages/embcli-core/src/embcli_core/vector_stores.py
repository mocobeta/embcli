...
class VectorStore(ABC):
    ...
    @abstractmethod
    def _index(self, collection: str, embeddings: list[list[float | int]], docs: list[DocumentType]):
        """Index the embeddings with documents."""
        pass
    ...
    @abstractmethod
    def _search(self, collection: str, query_embedding: list[float | int], top_k: int) -> list[HitDocument]:
        """Search for the top K documents."""
        pass
